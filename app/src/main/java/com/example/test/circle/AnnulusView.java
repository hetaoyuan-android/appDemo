...
public class AnnulusView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(com.example.test.R.styleable.TasksCompletedView_radius, 80);
    ...
    private void initVariable() {
        ...
        mCirclePaint1.setColor(R.color.color_353535);
...
//        canvas.drawCircle(mXCenter, mYCenter, mRadius + 10, mCirclePaint1);
        //内圆
//        canvas.drawCircle(mXCenter, mYCenter, mRadius -10, mCirclePaint);
       ...
       canvas.drawCircle(mXCenter, mYCenter, mRadius, mCirclePaint);
        ...
        canvas.drawArc(oval2, 0, 360, false, mRingPaintBg); //圆弧所在的椭圆对象、圆弧的起始角度、圆弧的角度、是否显示半径连线
        Log.e("++", "" + oval2.left + "++" + oval2.top + "++" +  oval2.right + "++" + oval2.bottom);
        ...
        Log.e("--", "" + oval1.left + "--" + oval1.top + "--" +  oval1.right + "--" + oval1.bottom);

...
public class CircleProgressOne extends View {
    ...
    public CircleProgressOne(Context context) {
        this(context, null);
    }

    public CircleProgressOne(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleProgressOne(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sweepAngle = 360 / totalTime * progress;
